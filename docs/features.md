...
| --------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Accueil**                 | Recherche globale, tags populaires et accès à un post aléatoire                                                                                                                                                                        | `src/routes/index.tsx`, `src/components/SearchBox.tsx`, `src/components/PopularTagsSection.tsx`                                                                                   |
| **Post aléatoire**          | `/random` choisit un post au hasard puis redirige vers son détail ; le lien est disponible sur l'accueil, dans la navigation desktop et dans le menu mobile                                                                            | `src/routes/random.tsx`, `src/lib/posts/posts.service.ts`                                                                                                                         |
