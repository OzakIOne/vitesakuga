...
| **Détail d'un post**      | Lecteur vidéo ou galerie d'images, métadonnées, post lié, tags, votes, commentaires, édition propriétaire, signalement, navigation épisode/chapitre et panneau « plus de cette série » | `src/routes/posts/$postId.tsx`, `src/components/PostDetail/PostDetailDisplay.tsx`, `src/components/SeriesHub.tsx`                                                      |
