...
| --------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Accueil**                 | Recherche globale, tags populaires et accès à une vidéo aléatoire                                                                                                                                                                      | `src/routes/index.tsx`, `src/components/SearchBox.tsx`, `src/components/PopularTagsSection.tsx`                                                                                   |
| **Vidéo aléatoire**         | `/random` choisit une vidéo publiée au hasard puis redirige vers son détail ; le lien est disponible sur l'accueil, dans la navigation desktop et dans le menu mobile                                                                  | `src/routes/random.tsx`, `src/lib/posts/posts.service.ts`                                                                                                                         |
