...
| M4 — Email verification not required               | **Open product decision**               | Better Auth email/password signup is enabled, but this repository does not currently require verified email before normal account use. Decide whether verification is required before launch.                                                                                                               |
...
1. Decide whether email verification is required for account creation and
   password recovery.
