...
export type SeriesPostKind = "chapter" | "episode" | "movie" | "other";
export type SeriesMetadataStatus = "complete" | "conflicting" | "incomplete";
...
export type SeriesArchiveReviewItem = {
